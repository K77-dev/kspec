...
- Template para a lista de tarefas: @.agents/templates/tasks-template.md
- Lista de tarefas: `@spec/tasks/$ARGUMENTS/tasks.md`
- Template para cada tarefa individual: @.agents/templates/task-template.md
- Tarefas individuais: `@spec/tasks/$ARGUMENTS/[num]_task.md`

### Formato do Resumo de Tarefas (tasks.md)

- Seguir o template em @.agents/templates/tasks-template.md

### Formato de Tarefa Individual ([num]_task.md)

- Seguir o template em @.agents/templates/task-template.md
