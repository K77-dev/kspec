...
- Controllers/Routes: diretório de rotas HTTP do projeto (consultar AGENTS.md para localização)
- Schemas de validação: diretório de schemas do projeto (consultar AGENTS.md para localização)
