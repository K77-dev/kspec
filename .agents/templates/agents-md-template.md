...
[Resumo breve com ponteiro para rule — ex: "Componentes funcionais, props tipadas — detalhes em `.agents/rules/react.md`"]

### Testes

[Resumo breve com ponteiro para rule — ex: "Unit: Vitest | E2E: TestSprite — detalhes em `.agents/rules/tests.md`"]
