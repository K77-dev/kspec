...
- Se a review **REPROVAR**, delegue novamente ao subagent `kspec-task-runner` com os problemas. Se reprovar 2x na mesma task, pare e reporte ao usuário com a lista de problemas não resolvidos.
