...
- Tech Spec requerido: `@spec/tasks/<SLUG>/techspec.md`
...
- Apresentar a lista high-level ao usuário com lista numerada para que o usuário possa aprovar, remover ou reordenar tasks (ex: "responda com os números das tasks que deseja manter, ou sugira alterações")
...
- Pasta da funcionalidade: `@spec/tasks/<SLUG>/`
- Template para a lista de tarefas: @./.gemini/templates/tasks-template.md
- Lista de tarefas: `@spec/tasks/<SLUG>/tasks.md`
- Template para cada tarefa individual: @./.gemini/templates/task-template.md
- Tarefas individuais: `@spec/tasks/<SLUG>/[num]_task.md`

### Formato do Resumo de Tarefas (tasks.md)

- Seguir o template em @./.gemini/templates/tasks-template.md

### Formato de Tarefa Individual ([num]_task.md)

- Seguir o template em @./.gemini/templates/task-template.md
