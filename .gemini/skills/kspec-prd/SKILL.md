...
- Template fonte: @./.gemini/templates/prd-template.md
...
1. Faça perguntas de clarificação ao usuário antes de gerar qualquer conteúdo.
...
- Use o template @./.gemini/templates/prd-template.md
