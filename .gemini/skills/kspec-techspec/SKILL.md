...
- Explore o projeto e consulte a documentação oficial dos frameworks antes de fazer perguntas — entender o contexto técnico e regras de negócio evita perguntas genéricas.
...
- Template Tech Spec: @./.gemini/templates/techspec-template.md
- PRD requerido: `spec/tasks/<SLUG>/prd.md`
- Documento de saída: `spec/tasks/<SLUG>/techspec.md`

## Pré-requisitos

- Confirmar que o PRD existe em `spec/tasks/<SLUG>/prd.md`
...
1. Faça perguntas técnicas ao usuário antes de gerar qualquer conteúdo.
...
- Usar @./.gemini/templates/techspec-template.md como estrutura exata
...
- [ ] Verificou as rules em @./.gemini/rules
- [ ] Arquivo escrito em `spec/tasks/<SLUG>/techspec.md`
